...
To install the ``django-api-blog`` project, run the following command in your terminal:
...
.. code-block:: console
   ...
   $ docker run -it django-api-blog-web bash
...
To run django-api-blog, locally, enter the following on the command line:
